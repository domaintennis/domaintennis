...
<meta content="DEiYt9EL8pXLmM9iDKq1Z1VYMBKah/O1d/65Rhdxnm8=" name="csrf-token" />
  ...
  <input type="text" name="q" id="command-bar" placeholder="Search or Type a Command" tabindex="1" data-username="digitalink" autocapitalize="off" />
  ...
  <div id="userbox">
    <div id="user">
      <a href="https://github.com/digitalink"><img height="20" src="https://secure.gravatar.com/avatar/a6685983a5d6bf82a08ed01241233580?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /></a>
      <a href="https://github.com/digitalink" class="name">digitalink</a>
    </div>
    <ul id="user-links">
      <li>
      ...
      <div class="hentry">
        ...
        <div class="pagehead repohead instapaper_ignore readability-menu">
          ...
          <li class="subscription">
              <form accept-charset="UTF-8" action="/notifications/subscribe" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="DEiYt9EL8pXLmM9iDKq1Z1VYMBKah/O1d/65Rhdxnm8=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="1092277" />
      ...
      <div class="context-body pane-selector">
        <ul class="js-navigation-container">
          ...
          <li class="js-toggler-container js-social-container starring-container ">
            ...
            </a><a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers">2,611</a>
          </li>

              <li><a href="/douglascrockford/JSON-js/fork" class="minibutton js-toggler-target fork-button lighter" rel="nofollow" data-method="post"><span class="mini-icon mini-icon-fork"></span>Fork</a><a href="/douglascrockford/JSON-js/network" class="social-count">686</a>
              </li>
  ...
  <ul class="tabs">
    ...
    <li><a href="/douglascrockford/JSON-js/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>0</span></a></li>
      ...
      <li><a href="/douglascrockford/JSON-js/issues" highlight="repo_issues">Issues <span class='counter'>2</span></a></li>
...
<div id="slider">
    ...
    <div class="breadcrumb" data-path="json2.js/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/douglascrockford/JSON-js" class="js-slider-breadcrumb" itemscope="url"><span itemprop="title">JSON-js</span></a></b> / <strong class="final-path">json2.js</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="json2.js" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    <div id="legal">
      ...
      <p>&copy; 2012 <span title="0.07892s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.08068' data-host='fe1'></span>
